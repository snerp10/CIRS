...
class dash:
    ...
    # Main window for the dashboard
        ...
        self.userLabel = Label(self.dashWindow,
                               text=f"Welcome Boss {self.current_user}",
    ...
    # Buttons for CRUD operations
        ...
        self.deleteAllButton.config(state = DISABLED)
    ...
    def update(self):
        ...
        if selected_item:
            ...
            if incident.reporter != self.current_user:
                messagebox.showwarning("Permission Denied", "You can only update your own reports!")
                return
    ...
    def delete(self):
        ...
        if selected_item:
            ...
            incident = self.manager.get_incident_by_id(selected_id)
            if incident.reporter != self.current_user:
                messagebox.showwarning("Permission Denied", "You can only delete your own reports!")
                return
